	...
	return(
		<div id='contact' className='FooterMain tc'>
			...
			<div className='FooterBody'>
				...
				<div className='FooterAdresses tc'>
					<div className='FooterAddressBox  shadow-3'>
						<p className='f5 b shadow-3 tracked pa3'>SADIQABAD OFFICE</p>
						<p className='f6 pt3 pa3'>
							PLOT # 20, GULSHAN-E-AZMAT, MAIN KLP ROAD, SADIQABAD, RAHIM YAR KHAN PUNJAB.
							<br /><br />
						</p>
						<p className='f6 pt3 pa3 b tc'>068 595 7121</p>
						
					</div>
					<div className='FooterAddressBox shadow-3'>
						<p className='f5 b shadow-3  tracked pa3'>KARACHI OFFICE</p>
						<p className='f6 pt3 pa3'>
						SUITE NUMBER 4, 2ND FLOOR, 14-C, 25TH COMMON STREET, PHASE 5, DHA, CLIFTON KARACHI
						<br /><br />
						</p>
						<p className='f6 pt3 pa3 b tc'>0300 100 5570</p>
					</div>
					<div className='FooterAddressBox shadow-3'>
						<p className='f5 b shadow-3  tracked pa3'>GHOTKI OFFICE</p>
						<p className='f6 pt3 pa3'>
							MAIN HIGHWAY ROAD NEAAR ADMORE FILLING STATION GHOTKI (65110), SINDH.
							<br /><br />
							</p>
						<p className='f6 pt3 pa3 b tc'>0723 668 550</p>
						</div>
				</div>
			...
			<div className='FooterSign tc f6 white'>
				<p className='b'>© 2020 Consol - Construction Solution. All Rights Reserved.</p>
				<p className='tracked-mega yellow hover-orange pointer'>Developed by Wajid Malik</p>
			</div>
